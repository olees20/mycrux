...
export type MemberMapFace = { id:string;name:string;widthMetres:number;heightMetres:number;angleDegrees:number;routeCount:number };
export type MemberMapStructure = { id:string;name:string;start:Point;end:Point;thicknessMetres:number;faces:MemberMapFace[] };
