...
export default function MarketingPage() {
  return (
    <section className="mx-auto grid min-h-[75vh] max-w-[var(--content)] items-center gap-10 px-5 py-16 md:grid-cols-[1.2fr_0.8fr]">
      <div>
        <p className="app-eyebrow text-[var(--muted)]">Your gym, connected</p>
      ...
      <div aria-hidden="true" className="aspect-square rounded-[3rem] bg-[var(--accent)] p-8 shadow-[inset_0_0_0_1px_rgba(0,0,0,.08)]">
        <div className="h-full rounded-[2rem] border-2 border-dashed border-[var(--border-strong)]" />
      </div>
    </section>
  );
}
