...
export default async function StaffRoutesPage({ params }: { params: Promise<{ gymSlug: string }> }) {
  ...
  const [{ data: walls }, { data: routes }, { data: memberships }] = await Promise.all([
  ...
  return <div className="mx-auto max-w-6xl">
    ...
    {wallOptions.length ? <><section className="mt-10"><h2 className="mb-4 text-xl font-black">Create a route</h2><RouteForm gymSlug={gym.slug} setters={setters} walls={wallOptions} /></section>
