  ...
  return (
    <div>
      <div className="max-w-3xl">
        <p className="app-eyebrow text-[var(--muted)]">Get started</p>
        <h1 className="mt-3 text-4xl font-extrabold tracking-[-.035em] tracking-tight sm:text-5xl">Choose how to continue</h1>
      ...
      <section aria-labelledby="join-gym-heading" className="mt-12 scroll-mt-6" id="join-gym">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
          <div className="rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--surface)] p-6">
          ...
          <div className="rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--surface)] p-6"><h3 className="text-xl font-black">Enter the gym code</h3><p className="mt-2 text-sm leading-6 text-[var(--muted)]">Use the eight-character code printed beside the gym’s QR.</p><GymCodeEntry /></div>
        </div>
      </section>
    </div>
  );
