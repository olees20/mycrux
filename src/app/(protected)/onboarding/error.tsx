...
export default function OnboardingError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <section className="mx-auto max-w-2xl rounded-[var(--radius-panel)] border border-red-200 bg-[var(--surface)] p-7 sm:p-10">
      <p className="app-eyebrow text-red-700">Something went wrong</p>
