...
export default async function CreateFirstGymPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <p className="mt-8 app-eyebrow text-[var(--muted)]">Create a gym</p>
      <h1 className="mt-3 text-4xl font-extrabold tracking-[-.035em] tracking-tight sm:text-5xl">Set up your organisation</h1>
