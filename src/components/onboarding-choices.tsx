...
export function OnboardingChoices() {
  return (
    <div className="mt-10 grid gap-5 md:grid-cols-2">
      <article className="flex flex-col rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm sm:p-8">
        <span aria-hidden="true" className="grid h-12 w-12 place-items-center rounded-[var(--radius-lg)] bg-[var(--accent)] text-2xl font-black">+</span>
      ...
      <article className="flex flex-col rounded-[var(--radius-panel)] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm sm:p-8">
        <span aria-hidden="true" className="grid h-12 w-12 place-items-center rounded-[var(--radius-lg)] bg-[var(--accent)] text-xl font-black">→</span>
