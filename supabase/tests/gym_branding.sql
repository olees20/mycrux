...
begin
  ...
  insert into storage.objects(bucket_id,name,owner_id,metadata) values('gym-branding',gym_id::text || '/11111111-1111-4111-8111-111111111111.png',auth.uid()::text,'{"mimetype":"image/png","size":4}');
  perform public.set_gym_logo_path(gym_id, gym_id::text || '/11111111-1111-4111-8111-111111111111.png');
  begin
...
begin
  ...
  begin
    insert into storage.objects(bucket_id,name,owner_id) values('gym-branding',gym_id::text || '/22222222-2222-4222-8222-222222222222.png',auth.uid()::text);
