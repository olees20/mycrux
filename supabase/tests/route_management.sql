...
('wall-images','30000000-0000-4000-8000-000000000001/61000000-0000-4000-8000-000000000001.webp',auth.uid()::text,'{"mimetype":"image/webp"}'),
('wall-images','30000000-0000-4000-8000-000000000001/61000000-0000-4000-8000-000000000002.webp',auth.uid()::text,'{"mimetype":"image/webp"}');

select public.attach_wall_image('30000000-0000-4000-8000-000000000001','61000000-0000-4000-8000-000000000012','30000000-0000-4000-8000-000000000001/61000000-0000-4000-8000-000000000001.webp','First wall image',1200,800,now());
select public.attach_wall_image('30000000-0000-4000-8000-000000000001','61000000-0000-4000-8000-000000000012','30000000-0000-4000-8000-000000000001/61000000-0000-4000-8000-000000000002.webp','Second wall image',1200,800,now());
